	...
	$db = new dbcon(); 
		try{ 
			...
			if ($res !== NULL){ 
					...
					echo "<tr><th>Wahl</th><th>ID</th><th>Vorname</th><th>Name</th><th>Adresse</th><th>PLZ</th><th>Ort</th><th>Datum</th><th>Login</th><th>Password</th><th>Level</th></tr>"; //?berschrift 
