...
<html> 
	...
	<style ="text/css">
	 ...
	 <?php 
		$db = new dbcon(); 
		try{ 
			$res = $db->getPersDetails('makler'); 
			if ($res !== NULL){ 
					echo "<table border='1'>"; //Tabellenbeginn 
					echo "<tr><th>Vorname</th><th>Name</th><th>Adresse</th><th>PLZ</th><th>Ort</th><th>Datum</th><th>Level</th></tr>"; //Überschrift 
